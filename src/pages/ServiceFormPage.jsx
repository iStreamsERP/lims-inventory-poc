...
export default function ServiceFormPage() {
  ...
  const fetchCategoryList = async () => {
    try {
      const payload = {
        SQLQuery:
          "SELECT DISTINCT GROUP_LEVEL1 from INVT_MATERIAL_MASTER WHERE GROUP_LEVEL1 IS NOT NULL AND GROUP_LEVEL1 &lt;&gt; '' AND COST_CODE = 'MXXXX' AND ITEM_GROUP = 'SERVICE' ORDER BY GROUP_LEVEL1",
      };
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="flex flex-col gap-4 lg:flex-row">
                  ...
                  <div className="flex flex-col justify-between gap-1 md:flex-row lg:w-[49%] lg:flex-row">
                    <div className="flex-1">
                                ...
                                {commandInputValue && (
                                  <Button
                                    ...
                                    onClick={() => {
                                      ...
                                      if (newValue) {
                                        setCategoryList((prev) => [...prev, { GROUP_LEVEL1: newValue }]);
                                        setFormData((prev) => ({
                                          ...prev,
