...
export default function IlmsCompClick({
  materialFormData,
  materials,
  isEditMode,
  loading,
                      ...
                      <TableCell className="px-2 py-1 text-right">
                        {editingQuantityId === m.ITEM_CODE ? (
                          ...
                          <div
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              setEditingQuantityId(m.ITEM_CODE);
                            }}
                          >
                            {m.QTY || 1}
                          </div>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Detailed information about the selected material
              </DialogDescription>
            </DialogHeader>
            {selectedMaterial && (
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <span className="col-span-3 text-sm">
                    {selectedMaterial.ITEM_NAME || selectedMaterial.DESCRIPTION || "-"}
                  </span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                  <span className="text-sm font-medium">Quantity:</span>
                  <span className="col-span-3 text-sm">
                    {selectedMaterial.QTY || 1}
                  </span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                  <span className="text-sm font-medium">Type:</span>
                  <span className="col-span-3 text-sm">
                    {selectedMaterial.QUOTATION_FOR || "Not specified"}
                  </span>
                </div>
              </div>
            )}
